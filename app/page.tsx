        ...
        <div className="container max-w-6xl mx-auto px-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 mb-12">
            ...
            <div className="flex items-center justify-center h-12 grayscale hover:grayscale-0 transition-all duration-300">
              <svg aria-label="Vercel logotype" className="h-6 w-auto" role="img" viewBox="0 0 262 52" xmlns="http://www.w3.org/2000/svg">
            ...
            <Button 
              ...
              variant="ghost" 
              size="sm"
              className="h-12 border border-dashed border-muted-foreground/30 hover:border-primary hover:bg-primary/5"
            >
              <Link href="mailto:adam.sobotka@duck.com?subject=prcat partnership">
                <span className="text-sm font-medium text-muted-foreground hover:text-primary">Your company?</span>
              </Link>
            </Button>
          </div>
